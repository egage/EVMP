...
emmeans(stmod_smsap_TCxFxB_acanc, ~ time_class | burned | fenced) %>% 
  ...
  geom_vline(aes(xintercept = 0), color= "black", size=1, lty="dashed") +
  labs(subtitle = "Point estimate displayed: median 
HPD interval probability: 0.95", x = "Estimate", y = "Contrast", caption = "All Winter Range, Aspen Stem Count, TCxFxB")
...
```{r}
color_scheme_set("teal")
mcmc_areas(posteriors.ac.stcnt.lg,
           prob = 0.9) +
  ggtitle("Posterior distributions",
                      "with medians and 90% credible intervals")
```
...
```{r}
color_scheme_set("teal")
mcmc_areas(posteriors.anc.stcnt.lg,
           prob = 0.9) +
  ggtitle("Posterior distributions",
                      "with medians and 90% credible intervals")
```
...
mcmc_areas(posteriors.ak.stcnt.lg,
           prob = 0.9) +
  ggtitle("Posterior distributions",
                      "with medians and 90% credible intervals") +
  theme_minimal()
...
emmeans(stmod_lgsap_TCxFxB_acanc, ~ time_class | burned | fenced) %>% 
  ...
  geom_vline(aes(xintercept = 0), color= "black", size=1, lty="dashed") +
  labs(subtitle = "Point estimate displayed: median 
HPD interval probability: 0.95", x = "Estimate", y = "Contrast", caption = "All Winter Range, Large Saplings, TCxFxB")
