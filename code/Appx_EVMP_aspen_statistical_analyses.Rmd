...
Bayesian analyses were fit separately for combined
...
Bayesian estimation was performed via MCMC adding independent weakly informed priors specific to the data type being modeled. 

# Likelihood

If the outcome for an observation $y$ is assumed to follow a Poisson
