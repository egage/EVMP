...
ggsave(plot = pl.hm1, filename = "./output/figures_202107/descriptive_background/cnt_plot_valley_x_fenced.png", width = 5, height = 4, dpi = 300)
...
# ggsave(plot = cow1, filename = "./output/figures_202107/descriptive_background/cnt_ptype_valle_x_fenced.png", width = 5, height = 4, dpi = 300)
...
# ggsave("./output/figures_202107/WCWNCWK_LI_shrubHt_FenBur_boxplot.png", width = 6.5, height = 4.875)
...
canopy.all.willow.sum %>%
  ...
  geom_text(aes(label = round(perc.above.thresh,1)), color = "grey80") +
  theme_minimal() +
  labs(x = "", y = "", fill = "% above \n threshold") +
...
csv.all.lc.mcro.df %>% 
  ...
  geom_text(aes(label = round(numeric.mean,1)), color = "grey80") +
  # scale_fill_viridis() +
  scale_fill_gradientn(colors = c("#26185F","#0095AF","#9ADCBB", "#FCFFDD")) +
  theme_minimal() +
...
ggsave("./output/figures_202107/willow_height/wilht_wc_wnc.png", width = 6.5, height = 3.75, dpi=300)
...
ggsave("./output/figures_202107/revised_figs_aspen/AC_ht_stemsAc_tile_revised.png", width = 9.75, height = 10.5)
...
asp.tally.dbh.tidy %>%
  ...
  ungroup() %>% 
  ggplot(aes(timeClass, DBHclGp01)) +  
  geom_tile(aes(fill = mean.tally), color = "grey80", alpha = .4) +
  # geom_tile(fill = "grey90", color = "grey80", alpha = .2) +
  geom_text(aes(label = mean.tally), size = 3) +
  facet_wrap(~FENCED) +
  theme_minimal() +
...
ggsave("./output/figures_202107/revised_figs_aspen/asp_burned_live_only_TCxF_mean.png", width = 6, height = 4)
...
ggsave("./output/figures_202107/revised_figs_aspen/asp_burned_only_TCxF_LiveXdead_meanCnt.png", width = 7, height = 5)
...
ggsave("./output/figures_202107/revised_figs_aspen/AC_diam_stemsAc_tile_rev.png", width = 7.5, height = 7.5)
```
...
ggsave("./output/figures_202107/revised_figs_aspen/ANC_diam_stemsAc_tile_rev.png", width = 7.5, height = 5.5)
...
ggsave("./output/figures_202107/revised_figs_aspen/AK_diam_stemsAc_tile_revised.png", width = 5.5, height = 3.5)
...
ggsave("./output/figures_202107/revised_figs_aspen/AspPercTotXdbh_ac_FxUf.png", width = 10, height = 5, dpi=300)
ggsave("./output/figures_202107/revised_figs_aspen/AsppercTotXdbh_ac_FxUf.pdf", width = 10, height = 5)
...
ggsave("./output/figures_202107/revised_figs_aspen/AspPercTotXdbh_anc.png", width = 7, height = 5, dpi=300)
ggsave("./output/figures_202107/revised_figs_aspen/AsppercTotXdbh_anc.pdf", width = 7, height = 5)
...
ggsave("./output/figures_202107/revised_figs_aspen/AspPercTotXdbh_ak.png", width = 5, height = 5, dpi=300)
ggsave("./output/figures_202107/revised_figs_aspen/AsppercTotXdbh_ak.pdf", width = 5, height = 5)
...
suckering.vtype %>%
  ...
  geom_col(aes(fill = perc_class), color="grey80") +
  theme_minimal() +
  # scale_fill_grey() +
  scale_fill_manual(values = colfunc2(3)) +
...
ggsave("./output/figures_202107/revised_figs_aspen/AspPercTotXsuckeringClass_ac_anc.png", width = 5, height = 5, dpi=300)
# ggsave("./output/figures_202107/revised_figs_aspen/AspPercTotXsuckeringClass_ac_anc.pdf", width = 5, height = 5)
...
## save revised figure
ggsave("./output/figures_202107/aspen_stem_count/AC_ANC_suckering_1p5to2p5m_fenced.png", width = 7.5, height = 5)
...
suckering.vtype.burned %>%
  ...
  # scale_fill_manual(values = c("darkgreen","green","grey90")) +
  scale_fill_grey() +
  # scale_fill_manual(values = colfunc1(3)) +
  theme_minimal() +
  # theme(legend.position = "top") +
...
ggsave("./output/figures_202107/AC_mean_dead_fenced_burned.png", width = 4.75, height = 3.5)
...
ggsave("./output/figures_202107/AC_Live_unFenced_Unburned_heightClass_heatmap3.png", width = 8.5, height = 6, dpi = 300)
...
ggsave("./output/figures_202107/revised_figs_aspen/AspPercTotXhtclass_ac_FxUf.png", width = 11, height = 5, dpi=300)
# ggsave("./output/figures_202107/revised_figs_aspen/AsppercTotXhtclass_ac_FxUf.pdf", width = 11, height = 5)
...
ggsave("./output/figures_202107/revised_figs_aspen/AspPercTotXhtclass_anc_FxUf.png", width = 7, height = 5, dpi=300)
# ggsave("./output/figures_202107/revised_figs_aspen/AspPercTotXhtclass_anc_FxUf.pdf", width = 7, height = 5)
...
ggsave("./output/figures_202107/revised_figs_aspen/AspPercTotXhtclass_ak.png", width = 5, height = 5, dpi=300)
# ggsave("./output/figures_202107/revised_figs_aspen/AspPercTotXhtclass_ak.pdf", width = 5, height = 5)

```

```{r}
# panel plot
plot.ac.fence2panel + plot.percTot.ANC + plot.percTot.ANC + plot.percTot.AK

# alt
plot.percTot.AC.F + plot.percTot.AC.UF + plot.percTot.ANC + plot.percTot.ANC + plot.percTot.AK

ggsave("./output/figures_202107/revised_figs_aspen/AspPercTotXhtclass_panel.png", width = 8, height = 6, dpi=300)
```
...
ggsave("./output/figures_202107/revised_figs_aspen/asp_animal_presence_2018.png", width=6, height = 5, dpi=300)
ggsave("./output/figures_202107/revised_figs_aspen/asp_animal_presence_2018.pdf", width=6, height = 5)
...
ggsave("./output/figures_202107/revised_figs_aspen/asp_animal_presence_2018_burned.png", width=6.5, height = 5, dpi=300)
ggsave("./output/figures_202107/revised_figs_aspen/asp_animal_presence_2018_burned.pdf", width=6.5, height = 5)
