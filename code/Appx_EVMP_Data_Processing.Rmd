---
title: "Supplemental Materials - EVMP Raw Data Processing"
author: ''
date: ''
output:
  word_document:
...
dbhclass.gradient5 <- c("#26185F", "#0095AF", "#9ADCBB", "#FCFFDD", "grey50")
colfunc1<-colorRampPalette(c("#26185F","#0095AF","#9ADCBB", "#FCFFDD"))
colfunc2<-colorRampPalette(c("#26185F","#9ADCBB", "#FCFFDD")) # new per request n=10 to change colors
# colfunc2alt<-colorRampPalette(c("#9ADCBB", "#FCFFDD"))
colfunc2alt<-colorRampPalette(c("grey10","grey80"))
colfunc3<-colorRampPalette(c("#26185F","#9ADCBB"))

# alt dark 
# #554594
# dbhclass.gradient5 <- c("#554594", "#0095AF", "#9ADCBB", "#FCFFDD", "grey50")
# colfunc1<-colorRampPalette(c("#554594","#0095AF","#9ADCBB", "#FCFFDD"))
# colfunc2<-colorRampPalette(c("#554594","#9ADCBB", "#FCFFDD")) # new per request n=10 to change colors
# colfunc3<-colorRampPalette(c("#554594","#9ADCBB"))
...
```{r, eval=FALSE, echo=FALSE}
visdat::vis_dat(bl.new)
visdat::vis_dat(csv.all.lc.mcro.df)
...
wilcov.tile.spp.wc <- canopy.all.spp %>% 
  ...
  theme_minimal() +
  theme(legend.position = "bottom") +
  labs(x = "Year", y = "Species", fill = "mean cover(%)", title = "Core Range", caption = "") +
  facet_wrap(~FENCED)
...
wilcov.tile.spp.wnc <- canopy.all.spp %>% 
  ...
  theme_minimal() +
  theme(legend.position = "bottom") +
  labs(x = "Year", y = "", fill = "mean cover(%)", title = "Noncore Range", caption = "") +
  facet_wrap(~FENCED)
...
wilcov.tile.spp.wk <- canopy.all.spp %>% 
  ...
  theme_minimal() +
  theme(legend.position = "bottom") +
  labs(x = "Year", y = "", fill = "mean cover(%)", title = "Kawuneeche Valley", caption = "willow_cov_wk.png") +
  facet_wrap(~FENCED)

wilcov.tile.spp.wk
ggsave("./output/figures_202108/willow_cov_wk.png", width = 5.5, height = 3.75, dpi=300)
...
ggsave("./output/figures_202108/willow_cov_wcwnc_3panel.png", width = 7.5, height = 3.75, dpi=300)
```
...
ggsave("./output/figures_202108/All_winter_range_willow_cov_boxplot_2panel_revised.png", width = 6.5, height = 3.75)
```
...
wts.2 %>%
  ...
  geom_col(aes(fill = zCond), color = "grey50", size=0.5) +
...
ggsave("./output/figures_202108/willowht_macroplot_WCWNCxF_tile_2panel.png", width = 7.5, height = 4.25, dpi = 300)
...
ggsave("./output/figures_202108/revised_WC_WNC_HtMeanDiff18BL_TCxfenced_dfc.png", width = 6.5, height = 3.75, dpi = 300)
...
ggsave("./output/figures_202108/wilht_allsp_macro_wc_wnc.png", width = 6.85, height = 3.75, dpi=300)
...
asp.tally.ht.tidy %>%
  ...
  labs(x = "", y = "", fill = "Stems/acre", title = "Tall and short sapling density in burned plots", caption = "Plots burned in 2012, AC, live trees only") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
ggsave("./output/figures_202108/AC_burned_live_sapHt2_only_TCxF_meanDen_lbl.png", width = 8, height = 4.75)
...
ggsave("./output/figures_202108/AC_Live_Fenced_Burned_PropDBH_barChart.png", width = 8, height = 6, dpi = 300)
...
ggsave("./output/figures_202108/AC_Live_Fenced_Burned_PropDBH_bc.png", width = 8, height = 6, dpi = 300)
...
ggsave("./output/figures_202108/AspPercTotXdbh_anc_botleg.png", width = 7, height = 5, dpi=300)
...
ggsave("./output/figures_202108/ANC_Live_PropDBH_bc.png", width = 8, height = 6, dpi = 300)
...
ggsave("./output/figures_202108/AspPercTotXdbh_ak.png", width = 5, height = 5, dpi=300)
# ggsave("./output/figures_202108/AsppercTotXdbh_ak.pdf", width = 5, height = 5)
...
# ggsave("./output/figures_202108/AK_Live_PropDBH_bc.png", width = 8, height = 6, dpi = 300)
...
ggsave("./output/figures_202108/AK_fenced_medTally.png", width = 4.25, height = 3.25, dpi = 300)
```
...
```{r aspHtClass_plots, fig.width=9}
...
asp.prop.ac.f <- ht.perc01 %>%
  ...
  theme_minimal() +
  # theme_bw() +
  labs(y = "% of total stems", x = "", fill = "Height class", title = "Proportion of Live Aspen Stems by Height Class", subtitle = "Fenced plots only", caption  = "AC_Live_Fenced_heightClass_revised.png") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  # theme(legend.position = "top") +
  scale_y_continuous(labels=scales::percent)

asp.prop.f  
# ggsave("./output/figures_202108/AC_Live_Fenced_heightClass_bd_bw.png", width = 8.5, height = 4.75, dpi = 300)
ggsave("./output/figures_202108/AC_Live_Fenced_heightClass_revised.png", width = 6.5, height = 7.5, dpi = 300)
...
asp.prop.ac.nf <- ht.perc01 %>%
  ...
  ggplot(aes(SITE_ID, percentTot)) +
  geom_col(aes(fill = HTclass2), color = "grey70", size=.5) +
  facet_wrap(~timeClass, ncol = 1) +
  scale_fill_grey() +
  # scale_fill_manual(values = colfunc2(5)) +
  # facet_grid(FENCED~timeClass) +
  ...
  # scale_fill_viridis_d(option = "D") +
  theme_minimal() +
  labs(y = "% of total stems", x = "", fill = "Height class", title = "Proportion of Live Aspen Stems by Height Class", subtitle = "Unfenced plots only", caption = "AC_Live_unFenced_heightClass_bc_bw.png") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  # theme(legend.position = "top") +
  scale_y_continuous(labels=scales::percent)

ggsave("./output/figures_202108/AC_Live_unFenced_heightClass_bc_bw.png", width = 7.5, height = 5.5, dpi = 300)
...
plot.percTot.ANC <- full_join(ht.perc01,sort.ht2join) %>% 
  ...
  # scale_fill_viridis(discrete=TRUE) +
  theme_minimal() +
  labs(y = "% of total stems", x = "", fill = "Height class", title = "Noncore Range", caption = "AspPercTotXhtclass_anc_FxUf.png") +
  # labs(y = "% of total stems", x = "", fill = "Height class", title = "Proportion of Live Aspen Stems by Height Class", subtitle = "Unfenced plots only") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) + 
  theme(legend.position = "bottom") +
  scale_y_continuous(labels=scales::percent)
...
# ggsave("./output/figures_202108/AspPercTotXhtclass_anc_FxUf.pdf", width = 7, height = 5)
...
ggsave("./output/figures_202108/AspPercTotXhtclass_ak.png", width = 6.5, height = 4.5, dpi=300)
...
# ggsave("./output/figures_202108/upland_species_max_ht.png", width = 6.5, height = 4, dpi = 300)
