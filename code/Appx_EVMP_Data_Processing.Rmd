...
This document provides code used to combine and pre-process a raw EVMP data files provided by RMNP. Raw data are combined and cleaned to facilitate exploratory data analyses, quality assurance, and statistical modeling. Specific issues addressed encountered and addressed include:   
* Inconsistently named/typed factors    
* Missing values
* Data values outside of expected range or showing unusual patterns

Derived data sets are produced and exported to for statistical analyses.
...
## Changing bl burned to unburned
...
# canopy.all.willow.sum %>%
#   write_csv("./output/exported_data/willow_macroplot_cover_BLto2018.csv") # re-exported 2/15/21
...
# ggsave("./output/figures_exported/revised_WC_WNC_HtMeanDiff18BL_TCxfenced_dfc.png", width = 5.5, height = 3.75, dpi = 300)
...
The following plots and tables summarize the beaver and moose presence observation for 2018
...
```{r}
## tidy up the height and dbh classes
## tidy the dbh
