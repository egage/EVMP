...
This document provides code used to combine and pre-process a raw EVMP data files provided by RMNP. Raw data are combined and cleaned to faciliate exploratory data analyses, quality assurance, and statistical modeling. Specific issues addressed encountered and addressed include:   
...
```{r}
## pull out the WC and WNC plot
wc.wnc.wt <- canopy.all.willow.sum %>%
  filter(SITE_TYPE != "WK")
