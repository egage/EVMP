...
# ggsave("./output/figures_exported/all_shrub_LI_boxplot01.png", width = 6.5, height = 4.875)

```

```{r}
csv.all.lc.li.df %>% 
  distinct(SPECIES_CODE) %>% gt::gt()
...
tabl.li.meanht1 <- csv.all.lc.li.df %>% 
  ...
  pivot_wider(names_from = yr, values_from = mean.max.ht)
...
path.offt <- ("./data/EVMP_data/TenYearReview/Willow_Offtake_Data_2009_Through_2018.xlsx")
