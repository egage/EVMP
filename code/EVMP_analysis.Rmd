...
dbh.perc.f %>%
  ...
  # theme_minimal() +
  theme_minimal() +
  labs(y = "Proportion of stems", x = "", fill = "DBH class", title = "Proportion of Live Aspen Stems by DBH Class", caption = "Fenced plots only") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
...
# ggsave("./output/figures_exported/suck_1p5to2p5m_AC_AN.png", width = 6.5, height = 6)
...
ggsave("./output/figures_exported/suck_1p5to2p5m_AC_burned.png", width = 4.5, height = 5.5)
...
# ggsave("./output/figures_exported/suck_1p5to2p5m_ANC_burned.png", width = 4.5, height = 5.5)


```

#### Percent of plot ic suckering class
...
# ggsave("./output/figures_exported/suck_class_AC_burned_fenced.png", width = 5.5, height = 3.75)
...
ggsave("./output/figures_exported/suck_class_ANC_burned_fenced.png", width = 5.5, height = 3.75)
...
# ggsave("./output/figures_exported/AC_fenced_medTally.png", width = 7.5, height = 3.25, dpi = 300)
...
ggsave("./output/figures_exported/AC_Live_Fenced_BurnUnbu_heightClass_heatmap3.png", width = 8.5, height = 4, dpi = 300)
...
# twig.raw %>% 
#   select(c(yr,sheet,date_of_collection)) %>%
#   distinct() %>% 
#   View()
...
```{r}
offt.raw <- offt.raw %>%
  filter(str_detect(sheet,pattern = "twig",negate = TRUE))
