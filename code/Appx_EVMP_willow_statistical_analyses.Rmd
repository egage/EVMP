...
posteriors.wc.wnc.ht.tidy %>%
  ...
  scale_fill_manual(values = colfunc2(ncol(posteriors.wc.wnc.ht.tidy))) +
...
ggsave("./output/figures_exported/willow_height/mcmcarea_willowht_TCxF_wcnc.pdf", width = 6.75, height = 3.75)
```
...
ggsave("./output/figures_exported/willow_height/mcmcarea_willowht_TCxF_wnc.png", dpi = 300, width = 6.75, height = 3.75)
ggsave("./output/figures_exported/willow_height/mcmcarea_willowht_TCxF_wnc.pdf", width = 6.75, height = 3.75)
```
...
# TC
stmod_ht_wk_TC <- stan_glmer(plant_ht_cm ~ time_class * fenced + (1 | site_id), data = willow.ht.wk,
                      family=Gamma(link="log"),
                      iter = 5000,
                      seed = 1234
                      )
...
ggsave("./output/figures_exported/willow_height/mcmcarea_willowht_TC_wk.png", dpi = 300, width = 6.75, height = 3.75)
ggsave("./output/figures_exported/willow_height/mcmcarea_willowht_TC_wk.pdf", width = 6.75, height = 3.75)
```
...
ggsave("./output/figures_exported/willow_height/mcmcarea_willowcov_TC_wcwnc.png", dpi = 300, width = 6.75, height = 3.75)
ggsave("./output/figures_exported/willow_height/mcmcarea_willowcov_TC_wcwnc.pdf", width = 6.75, height = 3.75)
```
...
wb.evmp18.willows <- read_csv("./data/EVMP_derived/wildbasin_evmp2018.csv")
