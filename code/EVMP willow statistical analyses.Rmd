...
Kawuneeche Valley (i.e., "willow" plots, see Zeigenfuss et al. 2011) and is provided as a supplement to the NPS NRR Report
...
pairs(wc.cov.emm.TCxF, reverse = TRUE) %>% 
  plot() +
  theme_minimal() +
  labs(subtitle = "Point estimate displayed: median 
...
pairs(wnc.cov.emm.TC, reverse = TRUE) %>% 
  plot() +
  theme_minimal() +
  labs(subtitle = "Point estimate displayed: median 
